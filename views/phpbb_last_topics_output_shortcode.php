<?php defined( 'ABSPATH' ) or die( 'forbidden' );
 ...
 if(empty($w3_ul_class_lt)){
  $w3all_lastopics_style_ul = ''; // inline style - change into whatever you need
  $w3all_lastopics_style_ul_class = 'w3all_ul_widgetLastTopics wp-block-latest-posts__list has-dates wp-block-latest-posts';
  $w3all_lastopics_style_li_class = 'w3all_li_widgetLastTopics';
 } else {
