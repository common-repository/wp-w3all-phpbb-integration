...
<hr />
<strong><span style="color:#ff0000">NOTE: it is maybe mandatory</span></strong> to transfer existent WordPress users into phpBB when the integration start, if you allow your users to register also into phpBB and the phpBB extension (and related option "check existence of username/email in WP before to register users in phpBB") are not active/installed.<br /><br />Note that if a WP user do not exist into phpBB, will be added into phpBB when the same user will login into WordPress<br /><br />
