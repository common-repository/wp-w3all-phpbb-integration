 ...
 if( strlen($w3all_url_to_cms) == strlen(get_option( 'w3all_url_to_cms' )) OR strlen($w3all_url_to_cms) == strlen(get_option( 'w3all_url_to_cms' )) + 1 )
{
 ...
 # A trick to set the Origin check for the iframed phpBB
...
<!-- START iframe div -->
<div style="width:100%;border:0;padding:0;margin:0;" id="" class="">
<iframe id="w3all_phpbb_iframe" style="overflow-x:scroll;height:100vh;width:1px;min-width:100%;*width:100%;border:0;" scrolling="no" src="<?php echo $w3all_url_to_cms; ?>"></iframe>
<?php
    echo "<script>
